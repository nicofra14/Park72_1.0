                          ...
                          var form_submit = function(e) {
                              ...
                              if (validate_form()) {
                                  ...
                                  async function submitForm() {
                                    ...
                                    const response = await fetch('https://chamione1463392.activehosted.com/proc.php?jsonp=true', {
                                      headers: {
                                  ...
                                  if (formSupportsPost) {
                                    ...
                                    _load_script('https://chamione1463392.activehosted.com/proc.php?' + serialized + '&jsonp=true', null, true);
                                  }
                              }
                              return false;
                          };
